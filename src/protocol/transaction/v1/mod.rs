...
impl Protobuf for TransactionBody {
    ...
    fn try_from_raw_ref(raw: &Self::Raw) -> Result<Self, Self::Error> {
        let raw::TransactionBody { actions, params } = raw;
    ...
    fn try_from_raw(proto: Self::Raw) -> Result<Self, TransactionBodyError> {
        let raw::TransactionBody { actions, params } = proto;
        let Some(params) = params else {
            return Err(TransactionBodyError::unset_params());
        };
...
impl TransactionBodyError {
    ...
    fn invalid_type_url(got: String) -> Self {
        Self(TransactionBodyErrorKind::InvalidTypeUrl { got })
    }
...
impl TransactionBodyBuilder {
    ...
    pub fn try_build(self) -> Result<TransactionBody, action::group::Error> {
        ...
        Ok(TransactionBody {
            actions,
            params: TransactionParams { nonce, chain_id },
        })
    }
}
...
mod tests {
    ...
    fn asset() -> crate::primitive::v1::asset::Denom {
        "nria".parse().unwrap()
    }
    ...
    fn signed_transaction_verification_roundtrip() {
        ...
        let to_address: crate::primitive::v1::Address = crate::primitive::v1::Address::builder()
            .array([0; 20])
